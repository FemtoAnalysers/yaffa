...
void MakeDistr(
    ...
    if (!doGenerate) {
        printf("Using events from existing production\n");
    ...
    printf("Starting analysis on %d events\n", nEvents);
