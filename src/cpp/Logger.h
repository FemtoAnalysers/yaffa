 ...
 * The level of detail is controlled by LOG_LEVEL, which can be specified at compile-time using:
 *   cmake -DLOG_LEVEL=40
 * By default, LOG_LEVEL=10, namely only errors and fatal errors are shown.
 */

#ifndef YAFFA_LOGGER_H
#define YAFFA_LOGGER_H
...
#ifndef LOG_LEVEL
#define LOG_LEVEL ERROR  // By default, only show problems
#endif
